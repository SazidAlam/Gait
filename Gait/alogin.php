...
<body>
  ...
  <h4 style="padding:10px; text-align: center; color: #757272;"> Login to Your account here. </h4>
        <form method="post" action="" class="login100-form validate-form flex-sb flex-w">
          ...
          <div class="flex-sb-m w-full p-t-3 p-b-24">
            <div style= " padding: 20px;">
              <a href="forgotpass.php" class="txt1" style="color: #757272;" >
                Forgot Password?
              </a>
            </div>
          </div>
          ...
          <div class="container-login100-form-btn m-t-17">
            <button class="login100-form-btn" style=" background-color: #5d5971; color: #e6e6e6;">
              Login
            </button>
          </div>
