  ...
  <section id="profile">
    <div class="container">
      <div class="row">
            ...
            <div class="card-body">
              <form>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="Sazid Alam">
                </div>
                <div class="form-group">
                  <label for="email">Email</label>
                  <input type="text" class="form-control" value="sazid.alam@northsouth.edu">
                </div>
                <div class="form-group">
        ...
        <div class="col-md-3">
          <h3>Your Avatar</h3>
          <img src="img/sazid.jpg" alt="" class="d-block img-fluid mb-3">
